...
export class ClubController {
  ...
  async getClubs(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result: DataResult<Array<Club>> =
        await this._clubService.getAllClubs();
  ...
  async updateClub(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result: Result = await this._clubService.updateClub(
        id,
        club,
        organizerId
      );
  ...
  async updateClubLogo(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result: Result = await this._clubService.updateClubLogo(
        id,
        logo,
        organizerId
      );
  ...
  async updateClubBanner(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result: Result = await this._clubService.updateClubBanner(
        id,
        banner,
        organizerId
      );
  ...
  async updateClubPresident(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const result: Result = await this._clubService.updateClubPresident(
        id,
        presidentId,
        updatedPresidentId
      );
