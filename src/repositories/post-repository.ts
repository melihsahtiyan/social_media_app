...
export class PostRepository implements IPostRepository {
	...
	async getFriendsPosts(userId: mongoose.Schema.Types.ObjectId): Promise<PostDoc[]> {
	...
	async likePost(postId: mongoose.Schema.Types.ObjectId, userId: mongoose.Schema.Types.ObjectId): Promise<PostForLike> {
