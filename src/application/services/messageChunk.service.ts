...
import { IMessageChunkRepository } from '../../persistence/abstracts/IMessageChunkRepository';
...
export class MessageChunkService implements IMessageChunkService {
	...
	constructor(
		@inject(RepositoryIdentifiers.IMessageChunkRepository) messageChunkRepository: IMessageChunkRepository,
